...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('../admin/lib/summernote/summernote-bs4.css')}}">
  </head>

  <body>

    <!-- START: LEFT PANEL-->
    <div class="sl-logo"><a href=""><img src="{{asset('../images/branding/Linnex-80x40.png')}}" alt="logo"></a></div>
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        <a href="/admin/home" class="sl-menu-link active">
        ...
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
            ...
            <span class="menu-item-label">Smart Phone</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('all.smartphone')}}" class="nav-link">All phones</a></li>
          <li class="nav-item"><a href="{{route('add.smartphone')}}" class="nav-link">Add phone</a></li>
        </ul>
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-gear-outline tx-24"></i>
            <span class="menu-item-label">Feature Phone</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('all.featurephone')}}" class="nav-link">All Phones</a></li>
          <li class="nav-item"><a href="{{route('add.featurephone')}}" class="nav-link">Add phone</a></li>
        </ul>
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              <img src="{{asset('../admin/img/admin.jpg')}}" class="wd-32 rounded-circle" alt="">
            </a>
